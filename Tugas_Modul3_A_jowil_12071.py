...
st.markdown("""
    <div class="center">
        <img src="https://media1.tenor.com/m/GFyZcrPO7B0AAAAC/monkey.gif" alt="Welcome Image">
    </div>
""", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: #4caf50;'>Prediksi IPK - 2071</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\Lenovo\Documents\Kuliah - UAJY\Semester V - 2024-2025\Pembelajaran mesin dan Pembelajaran Mendalam - A\Modul 03\Tugas3_A_12071'
